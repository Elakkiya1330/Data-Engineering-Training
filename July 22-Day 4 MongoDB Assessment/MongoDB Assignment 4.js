...
db.trainers.aggregate([
  ...
  { $lookup: { from: "sessions", localField: "trainer_id", foreignField: "trainer_id", as: "sessions" } },
  { $project: { name: 1, sessions: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $project: { member_name: { $arrayElemAt: ["$member.name", 0] }, trainer_count: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $project: { session_type: 1, duration: 1, member_name: { $arrayElemAt: ["$member.name", 0] }, trainer_name: { $arrayElemAt: ["$trainer.name", 0] } } }
])
...
db.sessions.aggregate([
  ...
  { $project: { trainer_name: { $arrayElemAt: ["$trainer.name", 0] }, total_time: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $lookup: { from: "members", localField: "_id", foreignField: "member_id", as: "member" } },
  { $project: { member_name: { $arrayElemAt: ["$member.name", 0] }, total_time: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $lookup: { from: "trainers", localField: "_id", foreignField: "trainer_id", as: "trainer" } },
  { $project: { trainer_name: { $arrayElemAt: ["$trainer.name", 0] }, session_count: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $limit: 1 },
  { $lookup: { from: "trainers", localField: "_id", foreignField: "trainer_id", as: "trainer" } },
  { $project: { trainer_name: { $arrayElemAt: ["$trainer.name", 0] }, avg_duration: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $lookup: { from: "trainers", localField: "_id", foreignField: "trainer_id", as: "trainer" } },
  { $project: { trainer_name: { $arrayElemAt: ["$trainer.name", 0] }, unique_members: 1 } }
])
...
db.sessions.aggregate([
  ...
  { $limit: 1 },
  { $lookup: { from: "members", localField: "_id", foreignField: "member_id", as: "member" } },
  { $project: { member_name: { $arrayElemAt: ["$member.name", 0] }, total_duration: 1 } }
])
...
db.members.aggregate([
  { $lookup: { from: "sessions", localField: "member_id", foreignField: "member_id", as: "session" } },
  { $match: { session: { $eq: [] } } },
  { $project: { name: 1, membership_type: 1 } }
])